    ...
    return (
      ...
      <div className="topic mb-3">
                    ...
                    <select name="sort" id="sort">
                        ...
                        <option value="lowtohigh" onClick={()=>{
                          {games.data}
...
export async function getServerSideProps(context) {
    ...
    let b = await fetch("https://murmuring-brushlands-13987.herokuapp.com/api/games?filters[genre]=Action-adventure&populate=*", {headers});
