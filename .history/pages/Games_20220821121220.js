        ...
        {props.games.data.map((item)=>{
          return(
            ...
            <div class="bg-gray-100 p-6 rounded-lg">
              <img class="h-40 rounded w-full object-cover object-center mb-6 h-20 w-5" src={process.env.NEXT_PUBLIC_STRAPI_HOST+ item.attributes.Poster.data.attributes.url}/>
