  ...
  return (
    <div> 
         ...
         <Navbar
                ...
                Signup={"Signup"}
            />
            <div className="w-full h-full bg-no-repeat bg-cover banner">
            <img alt="ecommerce"  src={ process.env.NEXT_PUBLIC_STRAPI_HOST + game.attributes.Banner.data.attributes.url }/>
