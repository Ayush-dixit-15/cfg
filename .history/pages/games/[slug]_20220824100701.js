            ...
            <h1>
              ...
              <div className={styles.track} >
              {
                ...
                return(
                  ...
                  <div className="p-4 cursor-pointer card">
                  <div className="bg-gray-100 w-full p-6 rounded-lg flex-col">
                    <img className="h-40 rounded object-cover object-center mb-6 " src={item.attributes.Poster.data.attributes.url}/>
