...
const Slug = ({game}) => {
    ...
    var bgImage = process.env.NEXT_PUBLIC_STRAPI_HOST+game.attributes.Banner.data.attributes.url ;
  return (
    <div> 
         ...
         <Navbar
            ...
            <div className="w-full h-full bg-no-repeat bg-cover" style={{
              backgroundImage: (`${process.env.NEXT_PUBLIC_STRAPI_HOST+game.attributes.Banner.data.attributes.url}`)
            }}>
